    ...
    operations = [
        migrations.CreateModel(
            ...
            fields=[
                ...
                ('dateBirth', models.DateField(blank=True, verbose_name='Дата народження')),
                ('telephone', models.IntegerField(blank=True, verbose_name='Номер телефону')),
                ('telephone2', models.IntegerField(blank=True, null=True, verbose_name='Номер телефону 2')),
                ('information', models.TextField(blank=True, verbose_name='Інформація про тренера')),
                ('photo', models.ImageField(blank=True, upload_to='coach/photo/%Y/%m/', verbose_name='Фото')),
